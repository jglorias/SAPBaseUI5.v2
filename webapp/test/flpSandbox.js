			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nodebaseui5-display": {
								"semanticObject": "nodebaseui5",
								"action": "display",
								"description": "Node.JS + Firebase + SAPUI5 Project.",
								"title": "NodebaseUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nodebaseui5",
									"url": sap.ui.require.toUrl("nodebaseui5")
								}
							}
						}
					}
